								...
								<#list page.list as ad2b>
									<tr class="odd gradeX">
										...
										<td class="text-center">
											...
											-->
											<button type="button" class="btn btn-danger btn-sm" onclick="BLogin.toRemove(${ad2b.pid!''}, '${ad2b.adid!''}', '${ad2b.bizid!''}');" data-toggle="modal" data-target="#removeATBModal" ><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> 删除</button>
										</td>
									</tr>
								</#list>
							<#else>
